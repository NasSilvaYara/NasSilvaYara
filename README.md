...
<p align="center">
  <span style="color:#58a6ff;">Desenvolvedora em Formação</span> • 
  <span style="color:#a371f7;">Tecnologia da Informação</span> • 
  <span style="color:#8b949e;">Desenvolvimento de Sistemas</span>
</p>

---

## <span style="color:#58a6ff;">Sobre</span>
...
Minha trajetória é voltada para desenvolvimento de software, com foco em construção de soluções organizadas, funcionais e escaláveis.

Minha base técnica foi construída através de formação estruturada em programação, desenvolvimento web e lógica computacional.

Além da área técnica, possuo experiência administrativa no Hospital São Paulo, o que fortaleceu minha organização, responsabilidade e visão sistêmica de processos.

Atualmente direciono meus estudos para desenvolvimento web moderno e backend.
...
## <span style="color:#a371f7;">Formação</span>

Tecnologia da Informação — FATEC Itaquera (2025 – atual)  
Técnico em Desenvolvimento de Sistemas — ETEC (2023 – 2024)  

Formações complementares:
Carreiras Digitais · UX/UI · Lógica de Programação  
Assistente Administrativo · Informática Profissional  

---

## <span style="color:#58a6ff;">Tecnologias</span>
